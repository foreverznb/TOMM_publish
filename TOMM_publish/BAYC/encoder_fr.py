...
class FileNameToImage(nn.Module):
    def __init__(self, num_files, embedding_dim, latent_shape, img_shape):
        ...
        self.decoder2 = nn.Sequential(
            fr.ConvTranspose2d(latent_shape[0], 512, kernel_size=4, stride=2, padding=1, minrate=0.5),
            nn.ReLU(),
            fr.ConvTranspose2d(512, 256, kernel_size=4, stride=2, padding=1, minrate=0.5),
            nn.ReLU(),
            fr.ConvTranspose2d(256, 128, kernel_size=4, stride=2, padding=1, minrate=0.5),
            nn.ReLU(),
            fr.ConvTranspose2d(128, 64, kernel_size=3, padding=1, minrate=0.5),
            nn.ReLU(),
            fr.ConvTranspose2d(64, 32, kernel_size=3, padding=1, minrate=0.5),
            nn.ReLU(),
            fr.ConvTranspose2d(32, 16, kernel_size=3, padding=1, minrate=0.5),
            nn.ReLU(),
            fr.ConvTranspose2d(16, img_shape[0], kernel_size=3, padding=1, minrate=0.5),
