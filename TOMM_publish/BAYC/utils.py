...
def upload_dict(state_dict_fr, state_dict_no_fr):
    for key in state_dict_fr.keys():
        if len(state_dict_fr[key].shape) == 1:
            ...
            state_dict_no_fr[key] = fr.idct_4d(state_dict_fr[key][:state_dict_no_fr[key].shape[0],:state_dict_no_fr[key].shape[1],:state_dict_no_fr[key].shape[2],:state_dict_no_fr[key].shape[3]])
        else:
            print('error')
