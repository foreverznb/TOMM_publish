...
if __name__ == '__main__':
    ...
    for j in range(len(output_imgs)):        
        img = np.clip(cv2.resize(output_imgs[j], (631, 631), interpolation=cv2.INTER_CUBIC), 0, 1)
